...
// ─── Dummy Doctors ─────────────────────────────────────────────────────────────
const DUMMY_DOCTORS = [
  { id: "dr-001", name: "Ananya Sharma", specialty: "General Physician", experience: "12 yrs", rating: 4.9, available: true, whatsapp: "+919999000001", slots: ["09:00 AM", "10:00 AM", "11:00 AM", "02:00 PM", "04:00 PM"], avatar: "AS", color: "from-violet-500 to-purple-600", about: "MBBS, MD – Expert in fever, infections & general health." },
  ...
  { id: "dr-006", name: "Viswajith", specialty: "General Physician", experience: "8 yrs", rating: 4.8, available: true, whatsapp: "+919072906576", slots: ["09:00 AM", "10:30 AM", "12:00 PM", "02:00 PM", "05:00 PM"], avatar: "SJ", color: "from-cyan-500 to-blue-600", about: "MBBS – General health consultations & preventive care." },
];
              ...
              {activeRoom ? (
                <div className="space-y-4">
                  ...
                  <div className="rounded-2xl overflow-hidden border border-gray-800 shadow-2xl" style={{ height: "60vh" }}>
                    <iframe
                      src={`https://meet.jit.si/${activeRoom}#userInfo.displayName="${user ? user.firstName : "Patient"}"&config.startWithAudioMuted=false&config.startWithVideoMuted=false`}
